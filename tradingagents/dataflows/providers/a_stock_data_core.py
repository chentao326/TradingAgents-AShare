"""
a-stock-data core module - Extracted from simonlin1212/a-stock-data SKILL.md
28 endpoints, 13 data sources, 7-layer China A-Share market data.
"""
...
# ── BEGIN: Extracted from a-stock-data SKILL.md ──
